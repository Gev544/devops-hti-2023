...
#name the vpc
echo "Creating vpc_name"
aws ec2 create-tags --resources "$vpcId" --tags Key=Name,Value="$vpcName"
error_handler vpc_name
#add dns support
...
error_handler internet_gateway
...
echo "ssh -i  $key_pair.pem ubuntu@$instance_ip"
