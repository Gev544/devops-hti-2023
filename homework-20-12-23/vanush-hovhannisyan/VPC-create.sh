...
# Launch EC2 instance
instance_id=$(aws ec2 run-instances --image-id $ami_id --instance-type $instance_type --subnet-id $subnet_id --security-group-ids $security_group_id --key-name $key_pair_name --query 'Instances[0].InstanceId' --output text)
